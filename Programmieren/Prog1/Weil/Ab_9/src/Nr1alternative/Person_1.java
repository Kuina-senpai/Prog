...
public class Person_1 {
	...
	public Person_1(String name, int gebJahr) {
	this();
	this.name = name;
	this.gebJahr = gebJahr;
	}

	public Person_1(String name, int gebJahr, double groesse, double gewicht) {
	this(name, gebJahr);
	...
	public static double bmis(double groesse, double gewicht) {
	return gewicht/(groesse*groesse);
	}

	public static double bmi(Person_1 p) {
	...
	public double bmi() {
	// Instanzmethode: ben�tigt keine Parameter
	return gewicht/(groesse*groesse);
	}
